...
\begin{subfigure}{.5\textwidth}
    ...
    \begin{feynman}
        ...
        \vertex at (4, -2) (o2);
        \diagram*{
            (i1) -- [fermion, edge label={\textit{c}}, at start] (a),
            (i2) -- [gluon, edge label={\textit{g}}, at start] (b),
            (a) -- [fermion, edge label={\textit{c}}] (b),
            (a) -- [scalar, edge label={\textit{H}}, at end] (o1),
            (b) -- [fermion, edge label={\textit{c}}, at end] (o2);
        };
    \end{feynman}
...
\begin{subfigure}{.5\textwidth}
    ...
    \begin{feynman}
        ...
        \diagram*{
            (i1) -- [fermion, edge label={\textit{c}}, at start] (a),
            (i2) -- [gluon, edge label={\textit{g}}, at start] (a),
            (a) -- [fermion, edge label={\textit{c}}] (b),
            (b) -- [scalar, edge label={\textit{H}}, at end] (o1),
            (b) -- [fermion, edge label={\textit{c}}, at end] (o2);
        };
    \end{feynman}
