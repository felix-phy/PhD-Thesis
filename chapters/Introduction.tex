...
\begin{figure}
    ...
    \caption{The leading order cH processes through which \yc\, may be probed, as each diagramm contains a vertex with a charm-quark and Higgs boson. The corresponding diagrams with an anti-charm quark $\overline{c}$ are implied.}
    \label{fig:cHFeynman}
\end{figure}
