...
The dataset used in this work is comprised of the 2018 dataset, recorded by the CMS experiment during Run-2 of the LHC. This dataset is comprised of an integrated luminosity of 58.83fb$^{-1}$ worth of data at a center-of-mass energy of 13 TeV. It is used in the estimation of reducible backgrounds described in \autoref{sec:ReducibleBackgrounds} as well as in \autoref{sec:sidebandValidation}, where it is used to verify the background estimation in sidebands of the primary signal region. The samples used to this end are summarised in \autoref{table:dataSamples}.
