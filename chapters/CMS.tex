...
\end{itemize}
The task of identifying \cjet s is thus twofold, as \cjet s must be differentiated from both \bjet s and light jets. This is broken down into two tasks:
\begin{enumerate}
