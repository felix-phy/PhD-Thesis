...
Since they are used to reconstruct the Higgs candidate in the cH, muons are a central element of this work. Using the available information from the tracker and muon system, three different approaches may be used to intially reconstruct muon tracks. 
...
The quarks and gluons that are produce in pp collisions rapidly hadronise, typically producing collimated cones of particle referred to as $jets$. Details on the concept of hadronisation, which results from the nature of the strong interaction, can be found in \cite{Hadronisation}. Since the c quark of the cH process too will produce a jet, jets are another central element of this work. \\
\\
