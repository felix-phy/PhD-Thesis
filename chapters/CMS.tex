...
\begin{enumerate}
    ...
    \item \textbf{The underlying event}: A description of a variety of effects secondary to the hard scattering must be included in the simulation. These can have several origins such as secondary, lower-energy interactions of the pp collision, or remnants of the collided protons that hadronise also themselves. These effects are modeled from data \cite{UnderlyingEvent}.
