...
\begin{figure}
    ...
    \caption{An illustration depicting the architecture of the DeepJet neural network \cite{DeepJet}. Three individual branches separately process the charged hadrons, neutral hadrons and secondary vertex information before being passed onto a combining, fully connected layer together with global variables.}
