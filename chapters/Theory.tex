...
\end{align}
\\
Effectively, this approach to interpreting $\kappa_{\mathrm{c}}$ from a signal strength measurement $\mu_{\sigma_{\mathrm{cH}}\mathcal{B}\mathrm{(H\rightarrow ZZ)}}$ ensures compatibility with existing Higgs boson rate measurements by connecting the scaling behaviour of the cH process with respect to \kappac \,, to the scaling of the total decay width of the Higgs boson. This is relevant as a non-unity value of $\kappa_{\mathrm{c}}$ leads to modifications of the Higgs boson partial decay widths, leading to a slight modification of the quadratic relationship one might naively expect between \kappac\, and $\mu_{\mathrm{cH}}$.
