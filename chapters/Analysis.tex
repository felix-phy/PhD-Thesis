...
Here, a validation of the described event selection is presented. Specifically, the 2018 dataset of the CMS detector is compared to simulation in sideband regions of the \cHZZ signal for a variety of observables. These sideband regions are defined as all selected events outside of the 100 GeV \textless $m$(H) \textless 130 GeV region, which is where the \cHZZ contribution is expected to be found. The only exception to this is the distribution of the mass of the Higgs boson candidate, shown in \autoref{fig:Higgs_pt_sideband}, for which the entire mass spectrum is shown for simulation to illustrate the presence of the \cHZZ signal around the Higgs boson candidate mass peak at $m(H) = 125.03$ GeV. The spectra in the sideband region of the Higgs boson candidate transverse momentum, the mass of the $Z_1$ and $Z_1$ candidate, as well as the transverse momentum, CvsL and CvsB discriminators of the selected jet, are shown in \autoref{fig:Higgs_pt_sideband} -- \autoref{fig:jet_CvsB_sideband} respectively. As seen in these distributions, a reasonable agreement between data and simulation is observed when accounting for the small event yields.

\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{figures/Higgs_mass.pdf}
    \caption{The mass spectrum of the Higgs boson candidate, showing the agreement between the 2018 dataset and simulation in the side band regions of the spectrum. The contribution from a \cHZZ signal, scaled by a factor 100 for better visibility, is also shown. The signal contribution is clearly concentrated around the Higgs boson mass of $m(H)=125$ GeV, as expected. }
...
\begin{figure}
    \begin{subfigure}{.5\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{figures/Higgs_pt.pdf}
        \caption{Higgs boson candidate transverse momentum.}
        \label{fig:Higgs_pt_sideband}
    \end{subfigure}%
    \begin{subfigure}{.5\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{figures/Z1_mass.pdf}
    ...
    \begin{subfigure}{.5\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{figures/Z2_mass.pdf}
        \caption{Mass of the $Z_2$ candidate.}
        \label{fig:Z2_mass_sideband}
    \end{subfigure}%
    \begin{subfigure}{.5\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{figures/jet_pt.pdf}
    ...
    \begin{subfigure}{.5\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{figures/jet_btagDeepFlavCvL.pdf}
        \caption{CvsL discriminator of the selected jet.}
        \label{fig:jet_CvsL_sideband}
    \end{subfigure}%
    \begin{subfigure}{.5\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{figures/jet_btagDeepFlavCvB.pdf}
...
\begin{figure}
    \begin{subfigure}{1\textwidth}
        ...
        \caption{Higgs boson candidate mass limited to [100 GeV,130 GeV].}
