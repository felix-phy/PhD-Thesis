...
\end{itemize}
Also of interest is the efficiency with which the `correct' jet is selected in the \cHZZ sample with the described jet selection method. This can be seen in \autoref{}. 
