...
As a baseline scenario, the mass of the Higgs boson candidate is used as a discriminator for the statistical evaluation, which is applied to the simulated 2018 dataset of the CMS detector. The distribution used for this can be seen in \autoref{fig:mHDisc}. For this scenario, an expected upper limit of \sBR$= 1073$ is set. This corresponds to an expected upper limit of $\kappa_c = 189$. Given the resonant nature of the peak around the Higgs boson candidate mass, which is shared by all Higgs production processes, this approach to setting upper limits on $\kappa_c$ can be interpreted as a measurement of an excess in jet-associated Higgs boson production. \\
\\
\begin{figure}
    \centering
