...
\begin{table}[H]
    ...
    \label{table:IrreducibleBackgroundSamples}
        ...
        ttH(ZZ$\rightarrow$4L) & 0.393 fb & xx \\ 
        W$^{-}$H(ZZ$\rightarrow$4L) & 0.147 fb & xx \\
        W$^{+}$H(ZZ$\rightarrow$4L) & 0.232 fb & xx \\
        ZH(ZZ$\rightarrow$4L) & 0.668 fb & xx \\
        qqH(ZZ$\rightarrow$4L) & 1.044 fb & xx \\
        tqH(ZZ$\rightarrow$4L) & 0.0213 fb & xx \\
        gg$\rightarrow$ZZ(4$\mu$) & 1.59 fb & xx \\
        gg$\rightarrow$ZZ(4$\tau$) & 1.59 fb & xx \\
        gg$\rightarrow$ZZ(2$\mu$2$\tau$) & 3.19 fb & xx \\
        qq$\rightarrow$ZZ/Z$\gamma^*\rightarrow$4L & 1.256 pb & 98488000 \\ 
        \midrule 
        bH 5FS FxFx & 0.7095 fb & xx \\
        bH 4FS &  0.365 fb & xx \\
        bH 5FS & 0.6573 & xx \\
        \midrule
        WZ$\rightarrow3\ell\nu$ & 4.43 pb & xx \\
...
Here, a validation of the described event selection is presented. Specifically, the 2018 dataset of the CMS detector is compared to simulation in sideband regions of the signal for a variety of observables. These side-band regions include all selected events outside of the 120 GeV \textless $m$(H) \textless 130 GeV region, which is where the primary \cHZZ contribution is expected to be found. The .. 
